...
export const isSettings = ajv.compile(SettingsSchema) as ValidateFunction<V3OfflineSettings>;
export default function validate(value: unknown): V3OfflineSettings {
  if (isSettings(value)) {
    return value;
  } else {
    throw new Error(
