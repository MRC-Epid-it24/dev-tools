export class Constants {
    ...
    static readonly foodDatabaseFileName = 'intake24_foods';
    static readonly imageDatabaseFileName = 'images.zip';
    static readonly systemDatabaseSchemaFileName = 'intake24_system_schema';
    static readonly systemDatabaseDataFileName = 'intake24_system_data';
}
